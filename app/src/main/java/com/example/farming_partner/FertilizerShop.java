...
public class FertilizerShop extends AppCompatActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fertilizer_shop);
    ...
    public void onClick(View v) {
        ...
        if (viewId == R.id.B_search) {
            ...
            type = "Fertilizer_supplier"; // Change to "post_office"
            toastMessage = "Searching Nearby Fertilizer suppliers"; // Change the toast message
        ...
        if (type != null) {
            ...
            Toast.makeText(FertilizerShop.this, toastMessage, Toast.LENGTH_LONG).show();
        }
    }
